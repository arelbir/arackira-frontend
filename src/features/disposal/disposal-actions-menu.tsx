...
import { DisposalRecord } from './disposal-schema';

interface DisposalActionsMenuProps {
  record: DisposalRecord;
  onEdit?: (record: DisposalRecord) => void;
  onDelete?: (record: DisposalRecord) => void;
  onDetail?: (record: DisposalRecord) => void;
}

const DisposalActionsMenu: React.FC<DisposalActionsMenuProps> = ({
  record,
  onEdit,
  onDelete,
  onDetail
...
export default DisposalActionsMenu;
