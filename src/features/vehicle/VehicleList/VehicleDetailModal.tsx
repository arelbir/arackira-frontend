...
import { useAllBrands } from '@/features/definitions/brands/use-brands';
import { useAllModels } from '@/features/definitions/models/use-models';
import { useAllColors } from '@/features/definitions/colors/use-colors';
...
const VehicleDetailModal: React.FC<VehicleDetailModalProps> = ({ vehicle, onClose }) => {
  // Tüm gerekli hook'ları yeni yapıya uygun şekilde kullan
